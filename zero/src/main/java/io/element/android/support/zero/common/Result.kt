package io.element.android.support.zero.common
...
val Result<*>.isSuccessOrFailure
    get() = (this is Result.Success) || (this is Result.Error)

val <T> Result<T>.data
    get() = if (this is Result.Success) this.data else null

val <T> Result<T>.error
    get() = if (this is Result.Error) this.exception else null
