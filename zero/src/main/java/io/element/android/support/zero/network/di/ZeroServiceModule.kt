...
object ZeroServiceModule {
    ...
    @Provides
    @SingleIn(AppScope::class)
    fun provideZeroFeedService(retrofit: ZeroRetrofitFactory): ZeroFeedService =
        retrofit.baseClient.create(ZeroFeedService::class.java)

    @Provides
    @SingleIn(AppScope::class)
    fun provideZeroFeedUserService(retrofit: ZeroRetrofitFactory): ZeroFeedUserService =
        retrofit.baseClient.create(ZeroFeedUserService::class.java)

    @Provides
    @SingleIn(AppScope::class)
    fun provideZeroWalletService(retrofit: ZeroRetrofitFactory): ZeroWalletService =
        retrofit.baseClient.create(ZeroWalletService::class.java)

    @Provides
    @SingleIn(AppScope::class)
    fun provideZeroStakingService(retrofit: ZeroRetrofitFactory): ZeroStakeService =
        retrofit.baseClient.create(ZeroStakeService::class.java)

    @Provides
    @SingleIn(AppScope::class)
    fun provideZeroMetaDataService(retrofit: ZeroRetrofitFactory): ZeroMetaDataService =
        retrofit.baseClient.create(ZeroMetaDataService::class.java)
}
