    ...
    ConfigureRoomOptions(
        ...
        options.reversed().forEach { item ->
            ...
            ListItem(
                ...
                headlineContent = {
                    val title = when (item) {
                        JoinRuleItem.PublicVisibility.Public -> stringResource(R.string.zero_group_type_public_title)
                        ...
                        JoinRuleItem.Private -> stringResource(R.string.zero_group_type_encrypted_title)
                    }
                    Text(text = title)
                },
                supportingContent = {
                    val description = when (item) {
                        JoinRuleItem.PublicVisibility.Public -> stringResource(R.string.zero_group_type_public_details)
                        ...
                        JoinRuleItem.Private -> stringResource(R.string.zero_group_type_encrypted_details)
                    }
