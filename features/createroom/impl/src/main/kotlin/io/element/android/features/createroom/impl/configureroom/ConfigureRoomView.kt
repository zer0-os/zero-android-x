    ...
    ConfigureRoomOptions(
        ...
        RoomVisibilityItem.entries.reversed().forEach { item ->
            ...
            ListItem(
                ...
                headlineContent = {
                    val title = when (item) {
                        RoomVisibilityItem.Public -> stringResource(R.string.zero_group_type_public_title)
                        RoomVisibilityItem.AskToJoin -> stringResource(R.string.screen_create_room_room_access_section_knocking_option_title)
                        RoomVisibilityItem.Private -> stringResource(R.string.zero_group_type_encrypted_title)
                    }
                    Text(text = title)
                },
                supportingContent = {
                    ...
                    val description = when (item) {
                        RoomVisibilityItem.Public -> stringResource(R.string.zero_group_type_public_details)
                        RoomVisibilityItem.AskToJoin -> stringResource(R.string.screen_create_room_room_access_section_knocking_option_description)
                        RoomVisibilityItem.Private -> stringResource(R.string.zero_group_type_encrypted_details)
                    }
